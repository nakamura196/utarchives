...
def excel_generator():
    ...
    api_url = "https://webpark5029.sakura.ne.jp/uta/api"
    ...
    table.append(row)
    row.append("Omeka ID")
    row.append("Omeka Created")
    row.append("Omeka Modified")
    ...
    for obj in rows:
        ...
        row.append(obj["o:id"])
        row.append(obj["o:created"]["@value"].split("T")[0])
        row.append(obj["o:modified"]["@value"].split("T")[0])
...
if __name__ == "__main__":
    ...
    # excel_generator(args.output_path)
    excel_generator()
